    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboard">
                <div class="sidebar-brand-text mx-3">Pengelolaan Aset Barang</div>
            </a>
            ...
            <!-- Nav Item - Charts -->
            <div class="sidebar-heading">Kelola Barang</div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <div class="mr-4">
                                    ...
                                    <span
                                        class=" d-none d-lg-block text-gray-600 small">{{ auth()->user()->nama }}</span>

                                    <div class="row">
                                        <span class="ml-3 d-none d-lg-block text-gray-600 small">
                                            {{ auth()->user()->bidang->nama_bidang }}</span>
                                        <span class="mx-1">| |</span>
                                        <span
                                            class=" d-none d-lg-block  text-gray-600 small">{{ auth()->user()->role }}</span>
                                    </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Dinas Komunikasi dan Informatika 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
